...
(function criarBotaoExecutar() {
  ...
  botao.textContent = 'Executar Script';
  botao.style.cssText = 'position: fixed; bottom: 20px; right: 20px; z-index: 10000; padding: 12px 20px; font-size: 16px; background-color: #007bff; color: white; border: none; border-radius: 8px; cursor: pointer; box-shadow: 0 2px 6px rgba(0,0,0,0.3);';
  botao.onclick = function() {
    alert("Script iniciado...");
    // Aqui começa o código que você deseja executar ao clicar no botão
    ...
    // Fim do código que você queria executar ao clicar no botão
  };
